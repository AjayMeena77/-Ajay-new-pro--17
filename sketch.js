...
function fruite (){
  if(World.frameCount%75===0){
   var fruit=createSprite(Math.round(random(350,600)),Math.round(random(0,600)),20,20); 
...
function enemy (){
  if(World.frameCount%180===0){
   var Monster=createSprite(Math.round(random(350,550)),Math.round(random(0,600)),20,20);
